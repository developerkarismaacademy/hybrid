    ...
    <section>
        ...
        background-size: cover;">
                    ...
                    <div class="col-12 title d-flex justify-content-center align-items-center">
                        <img src="/assets/front/images/KarismaGold.png" style="width: 50%;" alt="karisma gold">
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <img class="mx-3" src="/assets/front/images/Frame.png" alt="karisma gold"
                                                width="75">
                                            <div class="text">
                            ...
                            <div class="card-body bg-white">
                                <div class="row">
                                    <div class="col-6 d-md-flex d-block">
                                        <img class="mx-3" src="/assets/front/images/image1.png" alt="karisma gold"
                                            style="width: 25%">
                                    ...
                                    <div class="col-6 d-md-flex d-block">
                                        <img class="mx-3" src="/assets/front/images/koin1.png" alt="karisma gold"
                                            style="width: 25%">
                                        <div class="text d-flex d-md-block">
                                            <h5 class="card-title">
                                                <?= 0 ?>
                            ...
                            <div class="col-12 col-md-3">
                                <div class="card bg-white py-3 text-center" style="border-radius: 15px;">
                                    <div class="card-body d-flex justify-content-around align-items-center">
                                        ...
                                        <div class=" btn btn-primary px-4"><img src="/assets/front/images/Frame.png"
                                                width="20" alt=""> 1500</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-3">
                ...
                <div class="container-fluid  "
                    style="background: url('/assets/front/images/bgwhite.png'); background-size: cover;">
