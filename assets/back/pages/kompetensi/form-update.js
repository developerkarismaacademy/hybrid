var FormKompetensi = function () {
	...
	var idKompetensi = $('#id_kompetensi').val();
	...
	var kompetensiElement = $('#kompetensi');

	var kelas_id, mapel_id, kompetensi;

	var urlSimpanApi = base_url_api + "/KompetensiApi/update";
