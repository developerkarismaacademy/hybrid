var FormUpdateVideo = function () {
	...
	var nama_materi, kelas_id, mapel_id, bab_id, durasi, isi_materi, deskripsi_materi;
	...
	var initValidation = function () {
		formMateriElement.validate({
			...
			messages: {
				...
				'isi_materi': {
					required: 'Tugas Praktek Harus Di Isi',
	...
	var detailOpen = function () {
		...
		if (!loading) {
			...
			request.done(function (xhr, status, error) {
				...
				durasi = parseInt(xhr.data.durasi);
