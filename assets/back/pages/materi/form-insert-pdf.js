var FormInsertPDF = function () {
	...
	var webinarStatus = $('#webinar_status').val();
	...
	var pdfFileElement = $('#pdf_file');
	var imgGambarBabElement = $('#img-gambar-bab');
	var urlSimpanApi = base_url_api + "/MateriApi/simpanPdf";
	...
	var initValidation = function () {
		formMateriElement.validate({
			...
			messages: {
				...
				'url_video': {
					required: 'ID Youtube PDF Harus Di Isi',
					// checkYoutubePDF: 'PDF Tidak Di Temukan',
				}
			}
		});
	};
