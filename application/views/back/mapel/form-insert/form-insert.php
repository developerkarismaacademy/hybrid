							...
							<div class="m-t-10 clearfix">
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<input type="number" id="diskon_basic" value="80" min="10" max="90"
													   maxlength="2" name="diskon_basic"
										...
										<td>
											<div class="form-group">
												...
												<input type="number" id="diskon_silver" value="80" min="10" max="90"
													   maxlength="2" name="diskon_silver"
										...
										<td>
											<div class="form-group">
												...
												<input type="number" id="diskon_gold" value="80" min="10" max="90"
													   maxlength="2" name="diskon_gold"
								...
								<div class="form-group">
									...
									<div class="tags-default">
										<input type="text" value="" name="tag_mapel"
