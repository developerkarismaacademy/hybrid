					...
					<div class="page-title-box">
						<h4 class="page-title">
							<a data-toggle="tooltip" data-placement="top" title=""
							   data-original-title="Daftar Indikator Induk <?= $kompetensi['kompetensi'] ?>"
						...
						<ol class="breadcrumb p-0 m-0">
							<li>
								<a title="Daftar Indikator Induk <?= $kompetensi['kompetensi'] ?>"
								   href="<?= base_url('back/indikator-induk/' . $kompetensi['id_kompetensi']) ?>">
									<?= (strlen("Daftar Indikator Induk " . $kompetensi['kompetensi']) > 16 ? substr("Daftar Indikator Induk " . $kompetensi['kompetensi'], 0, 16) . "..." : "Daftar Indikator Induk " . $kompetensi['kompetensi']) ?>
								</a>
							</li>
							<li class="active">
								<span
				...
				<div class="col-sm-12">
					...
					<div class="card-box">
						...
						<form method="POST" id="form-indikator-induk" enctype="multipart/form-data">
							<input type="hidden" id="id_indikator_induk" name="id_indikator_induk" value="<?= $id ?>"/>
							...
							<div class="m-t-10 clearfix">
								...
								<div class="form-group">
									<label class="control-label">Deskripsi Indikator Induk</label>
									<textarea name="indikator_induk" id="indikator_induk" class="form-control"
											  rows="5"></textarea>
								</div>
								<div class="pull-right">
									<a href="<?= base_url('back/kompetensi/' . $mapel['meta_link_mapel']) ?>"
