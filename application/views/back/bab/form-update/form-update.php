						...
						<ol class="breadcrumb p-0 m-0">
							<li>
								<a title="Daftar Bab <?= $mapel['nama_mapel'] ?>"
								   href="<?= base_url('back/bab/' . $mapel['meta_link_mapel']) ?>">
									<?= (strlen("Daftar Bab " . $mapel['nama_mapel']) > 16 ? substr("Daftar Bab " . $mapel['nama_mapel'], 0, 16) . "..." : "Daftar Bab " . $mapel['nama_mapel']) ?>
								</a>
							</li>
							<li class="active">
								<span
					...
					<div class="card-box">
						...
						<form method="POST" id="form-bab" enctype="multipart/form-data">
							...
							<div class="m-t-10 clearfix">
								...
								<div class="form-group">
									<label class="control-label">Status Pretest</label>
									<br>
								...
								<div class="form-group">
									<label class="control-label">Status Posttest</label>
									<br>
									<input type="checkbox" id="posttest_status" name="posttest_status" value="1"
										   class="form-control" switch="none"/>
									<label for="posttest_status" data-on-label="Posttest"
										   data-off-label="Premium"></label>
								</div>
