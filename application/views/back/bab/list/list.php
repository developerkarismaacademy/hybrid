                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-box">
                        ...
                        if ($adminkah) {
                            ?>
                            <a data-toggle="tooltip" data-placement="top" title=""
                               data-original-title="Tambah Bab"
                               href="<?= base_url('back/bab/' . $mapel['meta_link_mapel'] . '/tambah') ?>"
                               class="btn btn-icon waves-effect waves-light btn-success">
                                <i class="fa fa-plus"></i>
                            </a>
                            <a data-toggle="tooltip" data-placement="top" title=""
                               data-original-title="Setting Urutan Bab <?= $mapel['nama_mapel'] ?>"
                               href="<?= base_url('back/bab/' . $mapel['meta_link_mapel'] . '/setting-urutan') ?>"
                        ...
                        ?>
                        <div class="btn-limit">
                            <select onchange="ListBab.limitChange()" class="selectpicker"
                        ...
                        <div class="table-responsive m-t-10">
                            <table
                                ...
                                <thead>
                                <tr>
                                    <th id="th-nama">Bab</th>
                                    <th id="th-pretest">Status</th>
                                ...
                                <tr id="clone-data" class="clone-data">
                                    <td class="nama-bab"> {{bab.nama_bab}}</td>
                                    <td class="status-bab"> {{bab.status_pretest}}</td>
                                    <td class="text-right">
                                        <a href="#"
                                           class="btn waves-effect waves-light btn-teal link-detail"
                                           data-toggle="tooltip"
                                           data-placement="top" title="" data-original-title="Detail Bab">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="#"
                                           class="btn waves-effect waves-light btn-info link-daftar"
                                           data-toggle="tooltip"
                                           data-placement="top" title="" data-original-title="Daftar Materi">
...
<div id="modal-detail" class="modal-demo">
    ...
    <h4 class="custom-modal-title" id="nama-mapel-detail-title">Detail Bab</h4>
    ...
    <div id="modal-container" class="custom-modal-text">
        <div class="table-responsive">
            <table class="table table-bordered m-0">
                ...
                <tr>
                    <td>Deskripsi</td>
                    <td id="deskripsi-bab-detail">Thornton</td>
                </tr>
                <tr>
                    <td>Status Pretest</td>
                    <td id="status-bab-detail">Thornton</td>
                </tr>
                <tr>
                    <td>Gambar</td>
                    <td>
                        <img src="<?= base_url() ?>/assets/back/images/no-image.jpg" id="img-gambar-bab-detail"
                             width="200">
                    </td>
                </tr>
                </tbody>
            </table>
            <button onclick="ListBab.modalClose();"
