		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="card-box">
						<form action="<?= base_url('back/unitkompetensi/tambah/') . $id ?>" method="post">
							<div class="form-group">
								<label for="" class="form-label">Kode Unit</label>
								<input type="text" class="form-control" id="" name="kode_unit">
							</div>
							<div class="form-group">
								<label for="" class="form-label">Judul Unit</label>
								<input type="text" class="form-control" id="" name="judul_unit">
							</div>
