			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="card-box">
						...
						<div class="btn-limit">
							<select onchange="ListTestimoniMapel.limitChange()" class="selectpicker"
						...
						<div class="table-responsive m-t-10">
							<table
								...
								<tr id="clone-data" class="clone-data">
									<td class="nama-mapel"> {{testimoni.nama_mapel}}</td>
...
<div id="modal-detail" class="modal-demo">
	...
	<div id="modal-container" class="custom-modal-text">
		<div class="table-responsive">
			...
			<button onclick="ListTestimoniMapel.modalClose();"
