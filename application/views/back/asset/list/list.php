					...
					<div class="page-title-box">
						<h4 class="page-title">
							<a data-toggle="tooltip" data-placement="top" title=""
							   data-original-title="Daftar Asset <?= $materi['nama_materi'] ?>"
						...
						<div class="table-responsive m-t-10">
							<table
								...
								<tr id="clone-data" class="clone-data">
									<td class="nama">{{asset.nama}}</td>
									<td class="link">{{asset.link}}</td>
									<td class="tipe">{{asset.tipe}}</td>
									<td class="text-right">
