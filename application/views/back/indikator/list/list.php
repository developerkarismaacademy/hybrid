					...
					<div class="page-title-box">
						<h4 class="page-title">
							<a data-toggle="tooltip" data-placement="top" title=""
							   data-original-title="Daftar Indikator Induk <?= $indikatorInduk['indikator_induk'] ?>"
				...
				<div class="col-sm-12">
					...
					<div class="card-box">
						...
						<button data-toggle="tooltip" data-placement="top" title="" data-original-title="Refresh Data"
								onclick="ListIndikator.refresh()"
								class="btn btn-icon waves-effect waves-light btn-primary">
							<i class="fa fa-refresh"></i>
						</button>
						<a data-toggle="tooltip" data-placement="top" title=""
						   data-original-title="Tambah Indikator"
						   href="<?= base_url('back/indikator/' . $indikatorInduk['id_indikator_induk'] . '/tambah') ?>"
						   class="btn btn-icon waves-effect waves-light btn-success">
							<i class="fa fa-plus"></i>
						</a>
						<div class="btn-limit">
							<select onchange="ListIndikator.limitChange()" class="selectpicker"
						...
						<div class="table-responsive m-t-10">
							<table
								...
								<thead>
								<tr>
									<th id="th-indikator-induk">Indikator Induk</th>
									<th id="th-indikator">Indikator</th>
								...
								<tr id="clone-data" class="clone-data">
									...
									<td class="indikator"> {{indikator.indikator}}</td>
									<td class="text-right">
										<a href="#"
										   class="btn waves-effect waves-light btn-teal link-detail"
										   data-toggle="tooltip"
										   data-placement="top" title="" data-original-title="Detail Indikator">
											<i class="fa fa-eye"></i>
										</a>
...
<div id="modal-detail" class="modal-demo">
	...
	<h4 class="custom-modal-title" id="nama-indikator-detail-title">Detail Indikator</h4>
		...
		<div class="table-responsive">
			<table class="table table-bordered m-0">
				...
				<tr>
					...
					<td style="width: 80%;" id="indikator-detail">Otto</td>
				</tr>

				</tbody>
			</table>
			<button onclick="ListIndikator.modalClose();"
