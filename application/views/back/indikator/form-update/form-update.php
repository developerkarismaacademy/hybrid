<div class="content-page">
	<div class="content">
		<div class="container">
				...
				<div class="col-xs-12">
					<div class="page-title-box">
						...
						<ol class="breadcrumb p-0 m-0">
							...
							<li>
								<a title="Daftar Indikator <?= $indikatorInduk['indikator_induk'] ?>"
								   href="<?= base_url('back/indikator/' . $indikatorInduk['id_indikator_induk']) ?>">
									<?= (strlen("Daftar Indikator" . $indikatorInduk['indikator_induk']) > 16 ? substr("Daftar Indikator " . $indikatorInduk['indikator_induk'], 0, 16) . "..." : "Daftar Indikator " . $indikatorInduk['indikator_induk']) ?>
								</a>
							</li>
							<li class="active">
								<span
			...
			<input type="hidden" id="idIndikator" value="<?= $id ?>">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="card-box">
						...
						<form method="POST" id="form-indikator" enctype="multipart/form-data">
							<input type="hidden" id="id_indikator" name="id_indikator" value="<?= $id ?>"/>
