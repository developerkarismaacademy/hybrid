...
<div class="content-page">
	<div class="content">
		<div class="container">
			...
			<!-- end row -->
			<input type="hidden" id="idKategoriKelas" value="<?= $kategori_kelas['id_kategori_kelas'] ?>">
				...
				<div class="col-sm-12">
					...
					<div class="card-box">
						...
						<a data-toggle="tooltip" data-placement="top" title="" data-original-title="Tambah Kelas"
						   href="<?= base_url('back/kelas/tambah') ?>"
								...
								<tr id="clone-data" class="clone-data">
									...
									<td class="text-right">
										...
										<a href="#"
										   ...
										   data-toggle="tooltip"
										   data-placement="top" title="" data-original-title="Detail Kelas">
											<i class="fa fa-eye"></i>
										</a>
										<?php
										}
										...
										<a href="#"
										   ...
										   data-toggle="tooltip"
										   data-placement="top" title="" data-original-title="Daftar Mata Pelajaran">
...
<div id="modal-detail" class="modal-demo">
	...
	<h4 class="custom-modal-title" id="nama-kelas-detail-title">Detail Kelas</h4>
	...
	<div id="modal-container" class="custom-modal-text">
		<div class="table-responsive">
			<table class="table table-bordered m-0">
				...
				<tr>
					<td>Deskripsi</td>
					<td id="deskripsi-kelas-detail">Thornton</td>
				</tr>
				<tr>
					<td>Gambar</td>
					<td>
						<img src="<?= base_url() ?>/assets/back/images/no-image.jpg" id="img-gambar-kelas-detail"
							 width="200">
					</td>
				</tr>
				</tbody>
			</table>
			<button onclick="ListKelas.modalClose();"
