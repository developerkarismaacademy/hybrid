			...
			<div class="row">
				<div class="col-xs-12">
					<div class="page-title-box">
						<h4 class="page-title">
							<a data-toggle="tooltip" data-placement="top" title="" data-original-title="Daftar Paket"
						...
						<ol class="breadcrumb p-0 m-0">
							<li><a href="<?= base_url('back/paket') ?>">Daftar Paket</a></li>
							<li class="active">
								<span
				...
				<div class="col-sm-12">
					...
					<div class="card-box">
						...
						<form method="POST" id="form-paket" enctype="multipart/form-data">
							<input type="hidden" id="id_paket" name="id_paket" value="<?= $id ?>"/>
							...
							<div class="pull-right">
								...
								<button type="button" onclick="FormPaket.reset();"
							...
							<div class="m-t-10 clearfix">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="harga_basic" name="harga_basic" placeholder="harga_basic" value="">
								</div>

								<div class="form-group">
									<label class="control-label">Harga Gold</label>
									<input type="text" name="harga_gold" id="harga_gold" class="form-control" placeholder="harga_gold" value="">
								</div>
