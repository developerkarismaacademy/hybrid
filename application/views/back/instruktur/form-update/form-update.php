        ...
        <div class="col-sm-12">
          ...
          <div class="card-box">
            ...
            <form method="POST" id="form-instruktur" enctype="multipart/form-data">
              <input name="id_instruktur" id="id_instruktur" type="hidden" value="<?= $id ?>">
              <input name="mapel_id" id="mapel_id" type="hidden" value="">
              ...
              <div class="m-t-10 clearfix">
                ...
                <div class="form-group">
                  ...
                  <textarea name="biodata" id="biodata" class="form-control"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="mapel_ampu" id="mapel_ampu" class="select2 form-control select2-multiple" multiple="multiple" multiple data-placeholder="Pilih Mata Pelajaran ...">
