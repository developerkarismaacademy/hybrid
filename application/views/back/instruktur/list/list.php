		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="card-box">
						<h4 class="m-t-0 header-title"><b>Daftar Instruktur</b></h4>
						<button data-toggle="tooltip" data-placement="top" title="" data-original-title="Refresh Data"
								onclick="ListInstruktur.refresh()"
								class="btn btn-icon waves-effect waves-light btn-primary">
							<i class="fa fa-refresh"></i>
						</button>
						<a data-toggle="tooltip" data-placement="top" title=""
						   data-original-title="Tambah Instruktur"
						   href="<?= base_url('back/instruktur/tambah') ?>"
						   class="btn btn-icon waves-effect waves-light btn-success">
							<i class="fa fa-plus"></i>
						</a>
						<div class="btn-limit">
							<select onchange="ListInstruktur.limitChange()" class="selectpicker"
						...
						<div class="table-responsive m-t-10">
							<table
								...
								<tr id="clone-data" class="clone-data">
									<td class="nama-instruktur"> {{instruktur.nama_instruktur}}</td>
									<td class="email-instruktur"> {{instruktur.email_instruktur}}</td>
									<td class="username-instruktur"> {{instruktur.username_instruktur}}</td>
									<td class="text-right">
										<a href="#"
										   class="btn waves-effect waves-light btn-teal link-detail"
										   data-toggle="tooltip"
										   data-placement="top" title="" data-original-title="Detail Instruktur">
											<i class="fa fa-eye"></i>
										</a>
										<a href="#"
										   class="btn waves-effect waves-light btn-warning link-ubah"
										   data-toggle="tooltip"
										   data-placement="top" title="" data-original-title="Ubah Data Instruktur">
