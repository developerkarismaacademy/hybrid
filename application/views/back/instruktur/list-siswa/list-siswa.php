					...
					<div class="page-title-box">
						<h4 class="page-title">
							<a data-toggle="tooltip" data-placement="top" title=""
							   data-original-title="Daftar Mata Pelajaran Yang Di Ampu"
							   href="<?= base_url('back/mapel-ampu') ?>">
						...
						<ol class="breadcrumb p-0 m-0">
							<li>
								<a title="Daftar Mata Pelajaran Yang Di Ampu" href="<?= base_url('back/mapel-ampu') ?>">
									<?= (strlen("Daftar Mata Pelajaran Yang Di Ampu") > 18 ? substr("Daftar Mata Pelajaran Yang Di Ampu", 0, 18) . "..." : "Daftar Mata Pelajaran Yang Di Ampu") ?>
								</a>
							</li>
							<li class="active">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="card-box">
						...
						<div class="btn-limit">
							<select onchange="ListSiswa.limitChange()" class="selectpicker" id="limit"
						...
						<div class="table-responsive m-t-10">
							<table class="table m-0 table-colored table-striped table-hover table-colored-bordered table-info table-bordered-info">
								<colgroup>
									...
									<col class="col-sm-3">
									<col class="col-sm-2">
									<col class="col-sm-1 text-center">
									<col class="col-sm-1 text-center">
								...
								<tr>
									...
									<th id="th-progress" class=" text-center">Progress</th>
									<th id="th-raport" class="text-center">Raport</th>
								...
								<tr id="clone-data" class="clone-data">
									...
									<td class="progress-siswa text-center"> {{siswa.progress_siswa}}</td>
									<td class="raport-siswa text-center">
										<input type="checkbox" name="raport-allowed" value="1"
											   class="form-control raport-allowed"/>
									</td>
									<td class="text-right">
										<a href="#" class="btn waves-effect waves-light btn-primary link-detail"
										   data-toggle="tooltip" data-placement="top" title=""
										   data-original-title="Hasil Siswa">
											<i class="fa fa-wpforms"></i>
										</a>
										<!-- <a href="#" class="btn waves-effect waves-light btn-teal link-indikator" data-toggle="tooltip" data-placement="top" title="" data-original-title="Penilaian Indikator Siswa">
											<i class="fa fa-check-square-o"></i>
										</a> -->
										<a href="#" target="_blank"
										   class="btn waves-effect waves-light btn-success link-raport"
										   data-toggle="tooltip" data-placement="top" title=""
										   data-original-title="Raport Siswa">
