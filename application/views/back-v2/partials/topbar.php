    ...
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-1">
            ...
            <div class="logo-topbar">
                ...
                <a href="index.html" class="logo-light">
                    ...
                    <span class="logo-sm">
                                    <img src="<?= base_url('assets/back-v2/') ?>assets/images/logo-sm.png"
                                         alt="small logo">
                                </span>
                </a>
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button"
                   aria-haspopup="false" aria-expanded="false">
                    <img src="<?= base_url('assets/back-v2/') ?>assets/images/flags/us.jpg" alt="user-image"
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?= base_url('assets/back-v2/') ?>assets/images/flags/germany.jpg" alt="user-image"
                    ...
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?= base_url('assets/back-v2/') ?>assets/images/flags/italy.jpg" alt="user-image"
                             class="me-1" height="12"> <span
                    ...
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?= base_url('assets/back-v2/') ?>assets/images/flags/spain.jpg" alt="user-image"
                             class="me-1" height="12"> <span
                    ...
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?= base_url('assets/back-v2/') ?>assets/images/flags/russia.jpg" alt="user-image"
                             class="me-1" height="12"> <span
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="<?= base_url('assets/back-v2/') ?>assets/images/users/avatar-1.jpg"
                           ...
                           class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="<?= base_url('assets/back-v2/') ?>assets/images/users/avatar-2.jpg"
                                                 class="img-fluid rounded-circle"
                                                 alt=""/>
                                        </div>
                                    </div>
                           ...
                           class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="<?= base_url('assets/back-v2/') ?>assets/images/users/avatar-3.jpg"
                                                 class="img-fluid rounded-circle"
                                                 alt=""/>
                                        </div>
                                    </div>
                           ...
                           class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="<?= base_url('assets/back-v2/') ?>assets/images/users/avatar-4.jpg"
                                                 class="img-fluid rounded-circle"
                                                 alt=""/>
                                        </div>
                                    </div>
                           ...
                           class="dropdown-item p-0 notify-item read-noti card m-0 shadow-none">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="<?= base_url('assets/back-v2/') ?>assets/images/users/avatar-5.jpg"
                                                 class="img-fluid rounded-circle"
                                                 alt=""/>
                                        </div>
                                    </div>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                    ...
                    <!-- item-->
                    <a href="<?= base_url('back-v2/logout') ?>" class="dropdown-item">
