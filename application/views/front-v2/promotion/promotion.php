...
<main>
    ...
    <section class="section-banner">
        <div class="container-fluid my-5 pt-3 px-0">
            <div id="carouselWeb  " class="carousel slide d-md-block d-none" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img  class="d-block w-100" src="<?= base_url('assets/front/img/').'1150.png'?>"
                              alt="<?= base_url('assets/front/img/').'1150.png'?>">
                    </div>
                    <div class="carousel-item ">
                        <img style="width: 100%" class="" src="<?= base_url('assets/front/img/').'1150x.png'?>"
                             class="d-md-block" alt="<?= base_url('assets/front/img/').'1150x.png'?>">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row content  m-3 responsive">
                <div class="col-lg-4 px-0" style="width: 190px !important;">
                    <a href="https://www.karier.mu/program/membuat-desain-media-promosi-di-adobe-photoshop-untuk-desainer-grafis-pemula" target="_blank" class="card px-0 text-decoration-none">
                ...
                <div class="col-lg-4 px-0">
                    <a href="https://www.karier.mu/program/merancang-strategi-iklan-digital-untuk-menjadi-profesional-periklanan-pemasaran" target="_blank" class="card px-0 text-decoration-none">
                ...
                <div class="col-lg-4 px-0">
                    <a href="https://www.karier.mu/program/membuat-desain-branding-produk-dengan-adobe-illustrator-bagi-desain" target="_blank" class="card px-0 text-decoration-none">
                ...
                <div class="col-lg-4 px-0">
                    <a href="https://hybrid.karismaacademy.com/kursus/detail/perancangan-gambar-kerja-bangunan-dengan-autocad" target="_blank" class="card px-0 text-decoration-none">
                        <img src="https://hybrid.karismaacademy.com/upload/banner_mapel/2d4049867afb9060af9d8e9ff597e8f6.png" class="card-img-top"
                             alt="Autocad.png">
                        <div class="card-body px-0">
                            ...
                            <p class="card-text d-flex mb-2 align-items-center"><img
                                        src="<?= base_url('assets/front/') ?>img/sell.png" class="mx-1"
                                        style="width: 20px; height: 20px">Rp 1.500.0000</p>
                            <p class="card-text">Perancangan Gambar Kerja Bangunan dengan AutoCAD </p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 px-0">
                    <a href="https://hybrid.karismaacademy.com/kursus/detail/mengembangkan-website-menggunakan-framework-laravel" target="_blank" class="card px-0 text-decoration-none">
                        <img src="https://hybrid.karismaacademy.com/upload/banner_mapel/fa3ca50c480b0c4f6f5874547d3edfcb.png" class="card-img-top"
                             alt="">
                        <div class="card-body px-0">
                            ...
                            <p class="card-text d-flex mb-2 align-items-center"><img
                                        src="<?= base_url('assets/front/') ?>img/sell.png" class="mx-1"
                                        style="width: 20px; height: 20px">Rp 1.500.0000</p>
                            <p class="card-text">Mengembangkan Website Menggunakan Framework Laravel </p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 px-0">
                    <a href="https://www.karier.mu/program/pembuatan-dokumen-elektronik-menggunakan-microsoft-word" target="_blank" class="card px-0 text-decoration-none">
                        <img src="https://hybrid.karismaacademy.com/upload/banner_mapel/427038ac35d06c401bb38cf3b6292c20.png" class="card-img-top"
                             alt="">
                        <div class="card-body px-0">
                            ...
                            <p class="card-text d-flex mb-2 align-items-center"><img
                                        src="<?= base_url('assets/front/') ?>img/sell.png" class="mx-1"
                                        style="width: 20px; height: 20px">Rp 1.500.0000</p>
                            <p class="card-text">Mengoperasikan dan Mengolah Kata Menggunakan Microsoft Word bagi Pegawai Kantor Umum </p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 px-0">
                    <a href="https://www.karier.mu/program/membuat-dan-mengoptimasi-website-di-wordpress" target="_blank" class="card px-0 text-decoration-none">
                        <img src="https://hybrid.karismaacademy.com/upload/banner_mapel/49122a91bc933417aee67468261a5ecd.png" class="card-img-top"
                             alt="">
                        <div class="card-body px-0">
                            ...
                            <p class="card-text d-flex mb-2 align-items-center"><img
                                        src="<?= base_url('assets/front/') ?>img/sell.png" class="mx-1"
                                        style="width: 20px; height: 20px">Rp 1.500.0000</p>
                            <p class="card-text">Membuat dan Mengoptimasi Website Di Wordpress bagi Spesialis Pemasaran Digital </p>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="container pt-4">
            <section class="section-content">
                <div class="row career">
                    <div class="col-12 col-lg-4 col-sm-12 d-flex align-items-end">
                        <img src="https://hybrid.karismaacademy.com/upload/mapel/54f742759bdf37c747cfbe1f1141d9fb.jpg" alt="budi"
                             class="img-fluid career-img wow mb-5 rounded fadeIn" data-wow-duration="2s">
                    </div>
    ...
    <section class="section-syarat">
        <div class="container">
            ...
            <div class="text wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">Periode Program akan
                berlangsung dari tanggal 1 Juni 2023 sampai dengan tanggal 30 Oktober 2023 (Periode Program).
            </div>
            <div class="clear"></div>
    ...
    <section class="section-keuntungan">
        ...
        <div class="ask pt-5">
            <div class="text">
                ...
                <a target="_blank" href="<?= base_url('profil/gamification')?>"
                ...
                <div class="col">
                    <div class="row">
                        <div class="offset-3 offset-md-0 col-9 col-md-4 col-sm-6 mb-3 mb-md-0 footer-social">
                            ...
                            <a class="icon-footer icon-footer-big d-inline-block if-fb w-25"
                               href="https://www.facebook.com/karismaacademy" target="_blank">
                                <img src="https://hybrid.karismaacademy.com/assets/front/v2/img/icon/footer-icon/fb.png"   alt="">
                            </a>
                            <a class="icon-footer icon-footer-big d-inline-block if-ig w-25" href="https://www.instagram.com/karismaacademy" target="_blank">
                                <img src="https://hybrid.karismaacademy.com/assets/front/v2/img/icon/footer-icon/ig.png"  alt="">
                            </a>
                        </div>
                        <div
