                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="tarik-saldo-label">Tarik Saldo
                                                            </h5>
                                                            ...
                                                            <form
                                                                ...
                                                                <div class="form-group text-left">
                                                                    ...
                                                                    <select class="form-control"
                                                                        id="exampleFormControlSelect1" name="bank-type" required>
                                        ...
                                        <?php foreach ($gamification_transaction as $gt): ?>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-12 col-lg-9 col-md-9 row">
                                                    ...
                                                    <div class="col-12">
                                                        <button
                                                            class="btn btn-<?= ($gt['status'] === 'success') ? 'success' : 'warning'; ?> btn-block btn-sm text-capitalize"><?= ($gt['status'] === 'success') ? 'success' : 'pending'; ?></button>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach ?>
                        ...
                        <table class="non-table">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="description">Beli Minimal 2 Kelas Prakerja di Karisma Academy dan dapatkan 600 Gold!!</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="description">Tukarkan 600 Gold untuk mendapatkan E-course Tips And Trick For Career Preparation!</td>
                                </tr>
                                <tr>
