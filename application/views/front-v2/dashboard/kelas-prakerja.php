...
<section id="sistem">
	...
	<div class="container-fluid bg-warning d-flex align-items-center">
		<div class="container">
			<div class="display-6 w-ld-50 ">
				<b>Pilihan Paket Kelas</b>
				<span>
					<button class="btn btn-paket-kelas btn-danger rounded-pill w-lg-25 ml-2"> Lihat Semua </button>
				</span>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
					...
					<div class="card text-white">
						<div class="container d-flex">
							<div class="card-body bg-prakerja px-lg-5">
								<h5 class="card-title my-lg-3 font-bg-coupon">Punya kupon <span class="font-weight-bold"> Pelatihan Prakerja</span>? Pakai kuponnya atau cek sertifikat prakerja Anda.</h5>
									<div class="d-flex justify-content-around justify-content-lg-start">
										<a href="" class="btn btn-warning btn-use-coupon d-flex px-0 pl-md-1 pr-md-2  mt-md-2 mr-md-3 pr-md-4">
											<img class="img-fluid pr-0 pt-0" src="<?= base_url('assets/front/v2/img/use-coupon.png') ?>"> Gunakan Kupon
										</a>
										<a href="" class="btn btn-light btn-check-coupon d-flex pl-0 pr-1 mt-md-2 pr-md-4">
											<img class="img-fluid pr-0" src="<?= base_url('assets/front/v2/img/check-serti.png') ?>"> Cek Sertifikat
										</a>
									</div>
							</div>
						</div>
				...
				<div class="col-12">
					<div class="card ">
						<div class="container d-flex">
							<div class="card-body bg-prakerja-2 px-lg-5">
								<div class="row">
									<div class="col-12 col-lg-7">
										<h5 class="card-title my-lg-3 py-md-1 font-weight-bold">Pelatihan Kartu Prakerja.</h5>
										<p>Karisma Academy adalah Lembaga pelatihan resmi Program Kartu Prakerja
											yang menyediakan berbagai pelatihan bersertifikat dalam berbagai bidang keahlian.
										</p> 
									</div>
									<div class="col-12">
									<a href="prakerja/" class="btn btn-warning btn-page-prakerja mr-2 mt-md-3 mt-2 ">
										Ke Halaman Prakerja</a>
									</div>
	...
	<div class="container-fluid " style="background: #F6FBFF;">
		...
		<div class="container">
			...
			<div class="row ">
				...
				<div class="col-12 h3 text-md-center mt-5">
					<b>Kelas Prakerja</b>
				</div>
			</div>
			...
			<div class="row d-flex mt-5 pb-5 justify-content-center">
				<div class="col-10 col-lg-4 text-center">
					<a class="btn btn-more-member btn-outline-warning text-white" href="<?= base_url("kelas") ?>#prakerja">Lihat Lebih Banyak </a>
				</div>
			</div>
		...
		<div class="container">
			<div class="row mb-5 pb-5">
				...
				<div class="col-12 col-md-12 col-lg-5 d-flex text-center ">
					<img class="mx-auto mx-lg-0 img-fluid img-float-pc " src="<?= base_url('upload/banner_mapel/img-float-pc.png') ?>">
					<img class=" img-fluid img-float-cs" src="<?= base_url('upload/banner_mapel/img-float-cs.png') ?>">
					<img class="mx-auto mx-lg-0 align-items-center img-fluid mt-3" style="width:100%; height:280px" src="<?= base_url('assets/front/v2/img/Illustrasi/dashboard-2.png') ?>">
				</div>
				...
				<div class="col-12 col-lg-7 d-flex flex-column justify-content-center  ">
					...
					<div class="row ">
						<div class="col-lg-2 col-3 col-md-2 mt-5 pt-4 pl-0 pl-md-1">
							<img class="mx-auto pl-3 pr-2 mx-lg-0 img-fluid  img-ikarisma" src="<?= base_url('upload/banner_mapel/server.png') ?>">
						</div>
						<!-- <p class="heading-sub"></p> -->
						...
						<div class="col-lg-10 col-9 col-md-10 pl-4 mt-5 ">
							...
							<p style="font-size: smaller; line-height:1.6" class="lead animate__animated animate__fadeInRight animate__delay-1s mt-3">
								<!-- Belajar online dengan metode paling beda. Siswa akan belajar dengan metode blended learning, dimulai dengan belajar melalui video dengan metode e-learning, menyelesaikan kuis, ujian, dan mengerjakan project portfolio sesuai standar industri masa kini. -->
						...
						<div class="col-lg-2 col-3 col-md-2 mt-5 pl-0 pl-md-1">
							<img class="mx-auto mx-lg-0 img-fluid img-ikarisma pl-3 pr-1" src="<?= base_url('upload/banner_mapel/server2.png') ?>">
						</div>
						<div class="col-lg-10 col-9 col-md-10 my-4 pl-4">
						...
						<br>
						<div class="col-lg-2 col-3 col-md-2 mt-3  pl-0 pl-md-1  ">
							<img class="mx-auto mx-lg-0 img-fluid img-ikarisma pl-3 pr-1 pr-md-2" src="<?= base_url('upload/banner_mapel/server3.png') ?>">
						</div>
						<div class="col-lg-10 col-9 col-md-10 pl-4 pl-0  ">
	...
	<div class="container pb-5">
		...
		<div class="row d-flex flex-wrap-reverse">
			<div class="col-12 col-lg-7 d-flex justify-content-end mb-3">
				...
				<div class="row ">
					<div class="col-lg-2 col-md-2 col-3 mt-5">
						<img class="mx-lg-0 pr-5 img-fluid" src="<?= base_url('upload/banner_mapel/live-logo.png') ?>" style="width:8em;">
					</div>
					<!-- <p class="heading-sub"></p> -->

					<div class="col-lg-9 col-md-10 col-9 pl-4 mt-3 ">
						<h5><b>Live Instruktur</b></h5>
						<p style="font-size: small; line-height:1.6" class="lead animate__animated animate__fadeInRight animate__delay-1s mt-3">
							<!-- Belajar online dengan metode paling beda. Siswa akan belajar dengan metode blended learning, dimulai dengan belajar melalui video dengan metode e-learning, menyelesaikan kuis, ujian, dan mengerjakan project portfolio sesuai standar industri masa kini. -->
					...
					<div class="col-lg-2 col-md-2 col-3 my-5 ">
						<img class="mx-lg-0 pr-5 img-fluid" src="<?= base_url('upload/banner_mapel/platform.png') ?>" style="width:8em;">
					</div>
					<div class="col-lg-9 col-md-10 col-9 my-4 pl-4">
			...
			<div class="col-12 col-lg-5 d-flex flex-column justify-content-center mb-4">
				<img class="mx-auto mx-lg-0 img-fluid " style="width:80%;  " src="<?= base_url('assets/front/v2/img/Illustrasi/robot.png') ?>">
			</div>
