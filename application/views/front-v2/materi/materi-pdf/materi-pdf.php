                                                        ...
                                                        <div class="form-group">
                                                            <form
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <?php
                                                                    $terlambat = date_diff(date_create($expired_absen), date_create(date('Y-m-d H:i:s')))->format('%d');
                                                                    ?>
                                                                    <?php if ($expired_absen !== null && $terlambat > 0): ?>
                                                                        <small
                                                                                style="font-size: 0.9rem;"
                                                                                class="text-danger">Anda
                                                                            terlambat absen silahkan masukan kode absen
                                                                            berikut untuk melanjutkan materi, kode
                                                                            absen: <b><?= $kode_absen ?></b></small>
                                                                    <?php endif ?>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <button type="submit"
