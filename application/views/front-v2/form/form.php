...
<section id="login" class="bg-ka-dark">
	<div class="container">
		<div class="row login-row">
			...
			<!-- <div class="col-lg-6 col-md-12 login-banners text-dark"> 
            </div> -->

			<div class="col-lg-12 col-md-12 login-main text-dark">
				...
				<div class="tab-content tab-animation tab-left" id="pills-tabContent">
					...
					//LOGIN
					?>
					<div class="tab-pane col-md-7 col-10 mx-auto mt-5 fade <?= $loginPage ?? "show active" ?>" id="pills-login" role="tabpanel"
					...
					//SIGNUP
					?>
					<div class="tab-pane  fade <?= $signupPage ?? "" ?>" id="pills-signup" role="tabpanel" aria-labelledby="pills-signup-tab">
                        <form action="<?= base_url("daftar") ?>" method="post" class="form-custom">
                            <div class="row mt-md-4 pt-md-3">
                                <div class="col-12 col-md-6"> 
                                    <div class="form-group">
                                        <label for="code_coupon">Coupon Code</label>
                                        <input type="text"
                                            class="form-control <?= (form_error('code_coupon') != "") ? " is-invalid " : "" ?>"
                                            id="code_coupon" name="code_coupon" value="<?= $code_coupon ?? "" ?>"
                                            aria-describedby="code_coupon" placeholder="Coupon Code">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea
                                        rows="3"
                                            class="form-control rounded <?= (form_error('address') != "") ? " is-invalid " : "" ?>"
                                            id="address" name="address" value="<?= $address ?? "" ?>"
                                            aria-describedby="daftarEmail" placeholder="Alamat">
                                            </textarea>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <button type="submit" class="btn py-1 my-0 my-md-3 btn-warning rounded-custom btn-lg btn-block">Daftar
                                        </button>
                                        <?php
                                        // <div class="form-text">Atau masuk dengan</div>
                                        // <div class="login-social">
